...
export const BUDGET_DATA = {
  ...
  quarterlyBills: [
    { name: 'Moxie', dueMonth: 'Jan', amount: 139, dueMonths: [1, 4, 7, 10] },
    { name: 'Garbage', dueMonth: '3,7,11', amount: 78, dueMonths: [3, 7, 11] },
    { name: 'Life Insurance', dueMonth: 'Quarterly', amount: 96, dueMonths: [1, 4, 7, 10] },
    { name: 'Bruno', dueMonth: 'Quarterly', amount: 90, dueMonths: [3, 6, 9, 12] },
  ],
  yearlyBills: [
    { name: 'Mint (Ben)', dueMonth: 'Sept', amount: 400, dueMonths: [9] },
    { name: 'Mint (Nikki)', dueMonth: 'June', amount: 180, dueMonths: [6] },
    { name: 'Propane', dueMonth: 'Dec', amount: 129, dueMonths: [12] },
    { name: 'HOA', dueMonth: 'Dec', amount: 220, dueMonths: [12] },
    { name: 'Registration', dueMonth: 'Dec', amount: 400, dueMonths: [12] },
  ],
  spendTarget: {
    foodAndFun: 2000,
    label: 'Sapphire',
